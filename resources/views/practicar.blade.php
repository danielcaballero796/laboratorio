        ...
        <section>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    {!! Form::open(['route' => 'practica.store', 'method' => 'POST']) !!}
                    {!! Form::label('practica','Practica') !!}
                    {!! Form::textArea('sql',null,['class' => 'form-control', 'required']) !!}
                    {!! Form::hidden('idconsulta',$todos[0]->id,['class' => 'form-control', 'required']) !!}
                    <br>
                    {!! Form::label('seleccion','Indique si la consulta es practica o definitiva') !!}
                    {!! Form::select('seleccione',['practica'=>'Practica','definitiva'=>'Definitiva'],null,['class'=>'form-control']) !!}

                    <div class="form-group">
                        <br>
                        <button type="submit" href="{{ route('practica')}}" class="btn ufps-btn">Enviar</button>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
